...
public class Pacman extends JFrame {
	...
	public class Board extends GameBoard {
	 ...
	 pacmanx / blocksize + nrofblocks * (int)(pacmany / blocksize);
	     ...
	     * @param g2d 2D graphics context
	     */
	    public final void drawMaze(final Graphics2D g2d) {
	        short i = 0;
	        int x, y;
	    ...
	    public void GetImages() {
	      ...
	      ghost = new ImageIcon(
	              Board.class.getResource("Ghost1.gif")).getImage();
	      pacman1 = new ImageIcon(
	              Board.class.getResource("PacMan1.gif")).getImage();
	      pacman2up = new ImageIcon(
	              Board.class.getResource("PacMan2up.gif")).getImage();
	      pacman3up = new ImageIcon(
	              Board.class.getResource("PacMan3up.gif")).getImage();
	      pacman4up = new ImageIcon(
	              Board.class.getResource("PacMan4up.gif")).getImage();
	      pacman2down = new ImageIcon(
	              Board.class.getResource("PacMan2down.gif")).getImage();
	      pacman3down = new ImageIcon(
	              Board.class.getResource("PacMan3down.gif")).getImage();
	      pacman4down = new ImageIcon(
	              Board.class.getResource("PacMan4down.gif")).getImage();
	      pacman2left = new ImageIcon(
	              Board.class.getResource("PacMan2left.gif")).getImage();
	      pacman3left = new ImageIcon(
	              Board.class.getResource("PacMan3left.gif")).getImage();
	      pacman4left = new ImageIcon(
	              Board.class.getResource("PacMan4left.gif")).getImage();
	      pacman2right = new ImageIcon(
	              Board.class.getResource("PacMan2right.gif")).getImage();
	      pacman3right = new ImageIcon(
	              Board.class.getResource("PacMan3right.gif")).getImage();
	      pacman4right = new ImageIcon(
	              Board.class.getResource("PacMan4right.gif")).getImage();
	    }
	    @Override
